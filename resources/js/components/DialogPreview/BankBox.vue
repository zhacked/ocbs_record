        ...
        <div class="bank-wrapper"  style="padding-left:30px; padding-right:30px; !important;">
            ...
            <div class="bank-container d-flex justify-center align-center" v-else >
                <div class="bank bank1">  
                    ...
                    <span class="text-sm font-weight-medium">{{  Object.values(bankTarget).length ? bankTarget.bank_number : banks.length > 0 ? banks[0].bank_number : arenaDetails.bank_details.length > 0 ? arenaDetails.bank_details[0].bank_number  : '' }}</span>
