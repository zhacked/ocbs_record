                                        ...
                                        <v-col class="text-right">
                                            ...
                                            <div class="mt-5 pt-4">
                                                ...
                                                <v-row  class=" mb-1 no-gutters" >
                                                    ...
                                                    <v-col class="col-sm-6" >
                                                            <input type="text" v-model="computation.mobile.totalMWBet" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                    </v-col>
                                                </v-row>
                                                <v-row  class=" mb-1 no-gutters" >
                                                    <v-col class="col-sm-6 mt-2">
                                                    ...
                                                    <v-col class="col-sm-6" >
                                                            <input type="text" v-model="computation.mobile.totalDrawBet" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                    </v-col>
                                                </v-row>
                                            </div>
                                        </v-col>
                                        ...
                                        <v-col class="text-right">
                                            ...
                                            <v-row  class=" mb-1 no-gutters" >
                                                ...
                                                <v-col class="col-sm-6" >
                                                        ...
                                                        <input type="text"  v-model="computedAve.mwTotalPercent" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computedAve.drawTotalPercent" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computedAve.mwMobileTotalPercent" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computedAve.drawMobileTotalPercent" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computation.unclaimed" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computation.cUnpaid" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computation.operatorExpenses" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computedAve.netOpCommission" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computation.mobile.cashLoad" name="cashLoad" @blur="handleFormatted"  class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <v-row  class=" mb-1 no-gutters" >
                                                <v-col class="col-sm-6 mt-2">
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computation.mobile.cashWithdraw" name="cashWithdraw" @blur="handleFormatted" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <hr>
                                            <v-row  class=" mb-1 no-gutters" >
                                                ...
                                                <v-col class="col-sm-6" >
                                                        <input type="text" v-model="computedAve.depositReplenish" class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                                </v-col>
                                            </v-row>
                                            <hr>
                                            <hr>
                            ...
                            <div class="text-left  ">
                                <v-row class=" no-gutters ">
                                    ...
                                    <v-col  class="col-md-4">
                                        <input type="text"   v-model="commission_percent"  class="form-control form-control-sm computation" id="inputName" placeholder="0" >
                                    </v-col>
                                </v-row>
...
import { numberFormat, numberUnformat, mergeObject, valueSplit } from '../utility';
    ...
    export default {
        ...
        methods: {
           async showData(){
            ...
            openModel(data){
                ...
                const totalMobileMWBets = data.mobile ? data.mobile.total_meron_wala : 0;
                ...
                this.computation = {
                        ...
                        operatorExpenses: numberFormat(this.computation.operatorExpenses),
                        mobile: {
            ...
            onFileChange(event) {
                ...
                if (file) {
                    ...
                    ws.forEach(w => {
                        ...
                        arrayData.push(XLSX.utils.sheet_to_json(singleSheet, {header: 1}))
                    })
                    ...
                    arrayData[0].map(r => {
                        ...
                        if(Object.keys(r).length === 1) {
                           ...
                           const newObject = {};
                            delete Object.assign(newObject, r, {['A']: r[0] })[0];;
                            eventsCombined.push(Object.assign({}, valueSplit(newObject.A)))
                        }
                    })
                    ...
                    const combinedEvent = eventsCombined.reduce(function(result, current) {
        ...
        computed: {
            computedAve: function(){
                console.log('commission handling');
                const mwTotalPercent = numberFormat(parseFloat(this.commission_percent) * numberUnformat(this.computation.totalMWBet));
                const drawTotalPercent = numberFormat(parseFloat(this.commission_percent) * numberUnformat(this.computation.draw));
                const mwMobileTotalPercent = numberFormat(parseFloat(this.commission_percent) * numberUnformat(this.computation.mobile.totalMWBet));
                const drawMobileTotalPercent = numberFormat(parseFloat(this.commission_percent) * numberUnformat(this.computation.mobile.totalDrawBet));
                const netOpCommTotal =  numberUnformat(mwTotalPercent) + numberUnformat(drawTotalPercent) + numberUnformat(this.computation.unclaimed) + numberUnformat(this.computation.cUnpaid) + numberUnformat(this.computation.operatorExpenses)
                ...
                const depositReplenish = numberFormat(numberUnformat(this.computation.netWinLoss) - numberUnformat(netOpCommission) + numberUnformat(cashLoad ) - numberUnformat(cashWithdraw))
